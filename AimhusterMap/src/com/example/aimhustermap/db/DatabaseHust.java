...
//	public static final String OFFICEURL = "OfficeUrl";//qudiao
	public static final String LON = "Lon";
	public static final String LAT = "Lat"; 
	public static final String SORT = "Sort";
	public static final String RANK = "Rank";
//	public static final String DETAIL = "Detail";//qudiao
...
//	public static final int URLINDEX = 5;//
	public static final int LONINDEX = 5;
	public static final int LATINDEX = 6;
	public static final int SORTINDEX = 7;
	public static final int RANKINDEX = 8;
//	public static final int DETAILINDEX = 10;//
	public static final int RANKDEEPINDEX = 9;
